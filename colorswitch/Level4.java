...
public class Level4 extends Level {
    ...
    public Level4(double screenWidth, double screenHeight) {
            ...
            if(i == 0) {
                ...
                if (i % 3 == 0) {
                    ...
                    items.add((Item) createEntity(listItems[(int) (Math.random() * listItems.length)], x,
                            0.75 + (0.75 * (double) (i + 1) * screenHeight), 60, 20,
                            60, 20, 60, 60, 4));
                    compteurItems++;
                    ...
                    obstacles.add((Obstacle) createEntity(listObstacles[(int) (Math.random() * listObstacles.length - 1)],
                            x, 0.75 + (0.75 * (double) (i + 1) * screenHeight), 60, 20,
                            60, 20, 60, 60, 4));
                    compteurObstacles++;
        ...
        TwoRoundedCircles obstacle = new TwoRoundedCircles(x, 9.5 * screenHeight, 80, 1);
